    ...
    <body>
        ...
        <header class="top">
            <div>
                ...
                <p class="sub">Registro de entregas conformes de <strong>lenguas</strong> al cliente o destino.</p>
            </div>
        ...
        <div class="content">
            <p style="margin: 0;">
                Aquí podrás documentar actas de recepción, firmas de conformidad, incidencias y cierre de entregas cuando implementes las pantallas y la lógica de negocio.
            </p>
        </div>
    </body>
</html>
