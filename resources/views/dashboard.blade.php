...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <header class="top">
            <div>
                <h1>Dashboard</h1>
                <p class="sub">Resumen y métricas del inventario (contenido por definir).</p>
            </div>
        ...
        <div class="content">
            <p style="margin: 0;">
                Este es el módulo de panel. Aquí podrás colocar gráficos, totales y accesos rápidos cuando lo desarrolles.
            </p>
        </div>
    </body>
</html>
